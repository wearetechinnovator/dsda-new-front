...
const HotelCategory = () => {
	...
	const savedFilter = getFilterState("hotel-category");
	...
	const exportData = useMemo(() => {
		return data && data.map(({ hotel_category_name }, _) => ({
	...
	const get = async (searchValue = searchTxt) => {
		...
		try {
			...
			setFilterState("hotel-category", dataLimit, activePage);
	...
	const exportTable = async (whichType) => {
		if (whichType === "copy") {
			...
			downloadExcel(exportData, 'hotel-category-list.xlsx') // Pass data and filename
		}
		else if (whichType === "print") {
			printTable(tableRef, "Hotel Category List"); // Pass table ref and title
		}
		else if (whichType === "pdf") {
			let document = exportPdf('Hotel Category List', exportData);
	...
	return (
		<>
			<Nav title={"Hotel Category Table"} />
			<main id='main'>
				<SideNav />
							...
							<div className="add_new_compnent">
								<div className='flex flex-col md:flex-row justify-between items-center'>
									...
									<div className='flex flex-col md:flex-row items-center gap-2'>
										...
										{!isTrash && <button
											onClick={() => deleteData(selected, "hotel-category", true)}
										...
										{
											isTrash && <button
												onClick={() => restoreData(selected, "hotel-category")}
										...
										<button
											onClick={() => deleteData(selected, 'hotel-category')}
										...
										<button
											onClick={() => navigate("/admin/hotel-category/add")}
											className='bg-[#003E32] text-white '>
														...
														<Whisper
															...
															speaker={<Popover full>
																<div
																	...
																	onClick={(e) => {
																		e.stopPropagation()
																		navigate("/admin/hotel-category/edit/" + d._id)
																	}}
																>
																...
																<div
																	...
																	onClick={(e) => {
																		e.stopPropagation()
																		deleteData(d._id, "hotel-category");
																	}}
																>
																...
																<div
																	...
																	onClick={(e) => {
																		e.stopPropagation()
																		deleteData(d._id, "hotel-category", true);
																	}}
																>
																	<Icons.DELETE className='text-[16px]' />
																	Trash
