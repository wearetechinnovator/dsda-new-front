...
const RoomType = () => {
	...
	const get = async () => {
		try {
			...
			setFilterState("room-type", dataLimit, activePage);
			const url = process.env.REACT_APP_MASTER_API + `/room-type/get`;
	...
	const exportTable = async (whichType) => {
		if (whichType === "copy") {
			...
			downloadExcel(exportData, 'room-type-list.xlsx') // Pass data and filename
		}
		else if (whichType === "print") {
			printTable(tableRef, "Room Type List"); // Pass table ref and title
		}
		else if (whichType === "pdf") {
			let document = exportPdf('Room Type List', exportData);
							...
							<div className="add_new_compnent">
								<div className='flex flex-col md:flex-row justify-between items-center'>
									...
									<div className='flex flex-col md:flex-row items-center gap-2'>
										...
										{!isTrash && <button
											onClick={() => deleteData(selected, "room-type", true)}
										...
										{
											isTrash && <button
												onClick={() => restoreData(selected, "room-type")}
										...
										<button
											onClick={() => deleteData(selected, 'room-type')}
										...
										<button
											onClick={() => navigate("/admin/room-type/add")}
											className='bg-[#003E32] text-white '>
														...
														<Whisper
															...
															speaker={<Popover full>
																<div
																	...
																	onClick={(e) => {
																		e.stopPropagation()
																		navigate("/admin/room-type/edit/" + d._id)
																	}}
																>
																...
																<div
																	...
																	onClick={(e) => {
																		e.stopPropagation()
																		deleteData(d._id, "room-type", true);
																	}}
																>
																	<Icons.DELETE className='text-[16px]' />
																	Trash
