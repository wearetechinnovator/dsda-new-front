...
const Zone = () => {
	...
	const savedFilter = getFilterState("zone");
	...
	const get = async () => {
		try {
			...
			setFilterState("zone", dataLimit, activePage);
	...
	const exportTable = async (whichType) => {
		if (whichType === "copy") {
			...
			downloadExcel(exportData, 'zone-list.xlsx') // Pass data and filename
		}
		else if (whichType === "print") {
			printTable(tableRef, "Zone List"); // Pass table ref and title
		}
		else if (whichType === "pdf") {
			let document = exportPdf('Zone List', exportData);
							...
							<div className="add_new_compnent">
								<div className='flex flex-col md:flex-row justify-between items-center'>
									...
									<div className='flex flex-col md:flex-row items-center gap-2'>
										...
										{!isTrash && <button
											onClick={() => deleteData(selected, "zone", true)}
										...
										{
											isTrash && <button
												onClick={() => restoreData(selected, "zone")}
										...
										<button
											onClick={() => deleteData(selected, 'zone')}
										...
										<button
											onClick={() => navigate("/admin/zone/add")}
											className='bg-[#003E32] text-white '>
