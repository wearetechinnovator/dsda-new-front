...
const District = () => {
	...
	const savedFilter = getFilterState("district");
	...
	const exportTable = async (whichType) => {
		if (whichType === "copy") {
			...
			downloadExcel(exportData, 'district-list.xlsx') // Pass data and filename
		}
		else if (whichType === "print") {
			printTable(tableRef, "District List"); // Pass table ref and title
		}
		else if (whichType === "pdf") {
			let document = exportPdf('District List', exportData);
							...
							<div className={`add_new_compnent`}>
								<div className='flex flex-col md:flex-row justify-between items-center'>
									...
									<div className='flex flex-col md:flex-row items-center gap-2'>
										...
										<button
											onClick={() => navigate("/admin/district/add")}
											className='bg-[#003E32] text-white'>
														...
														<Whisper
															...
															speaker={<Popover full>
																<div
																	...
																	onClick={(e) => {
																		e.stopPropagation()
																		navigate("/admin/district/edit/" + d._id)
																	}}
																>
