...
const AddDisctrictComponent = ({ mode, save }) => {
    ...
    const saveData = async (e) => {
        ...
        try {
            const url = mode ? process.env.REACT_APP_MASTER_API + "/district/update" : process.env.REACT_APP_MASTER_API + "/district/create";
            ...
            toast(!mode ? "District create success" : "District update success", 'success');
            ...
            if (save) {
                ...
                // return navigate("/admin/district")
            }
