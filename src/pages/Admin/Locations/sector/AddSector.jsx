...
const AddSector = ({ mode, save }) => {

    return (
        <>
            <Nav title={mode ? "Update Sector " : "Add New Sector"} />
            <main id='main'>
                <SideNav />
                <SectorComponent mode={mode} save={save} />
            </main>
        </>
    )
}
...
const SectorComponent = ({ mode, save }) => {
    ...
    const saveData = async (e) => {
        ...
        try {
            const url = mode ? process.env.REACT_APP_MASTER_API + "/sector/update" : process.env.REACT_APP_MASTER_API + "/sector/create";
            ...
            toast(!mode ? "Sector create success" : "Sector update success", 'success');
