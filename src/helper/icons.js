...
export const Icons = {
  ...
  INFO_DETAILS: IoMdInformationCircleOutline,
  DROPDOWN: MdOutlineArrowDropDown,
  DROPUP: RiArrowDropUpFill,
  USERS: FaUsers,
  TREDING_UP: MdOutlineTrendingUp,
  TREDING_DOWN: IoMdTrendingDown,
  RUPES: MdOutlineCurrencyRupee,
  BOOK: LuBookText,
  PREV_PAGE_ARROW: GrFormPrevious,
